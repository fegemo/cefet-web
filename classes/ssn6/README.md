...
> Atualmente, ele está neste endereço: https://terrivel.onrender.com/monster.
...
- <!-- {li:style="list-style-type: none"} -->
  ```html
  <form action="https://terrivel.onrender.com/monster" method="GET">
...
- Requisições enviadas via `GET` e `POST` <!-- {ul:.full-width} -->
  - <!-- {ul:.layout-split-2.no-padding.no-bullets.no-margin.compact-code-more} -->
    ...
    Host: terrivel.onrender.com?nome=Fl%C3%A1vio+Coutinho
